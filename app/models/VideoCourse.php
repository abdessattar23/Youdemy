...
class VideoCourse extends Course {
    public function create($title, $description, $category_id, $tags, $link) {
        ...
        $stmt = $this->db->prepare('INSERT INTO courses (title, description, category_id, type, link, teacher_id) VALUES (:title, :description, :category_id, "video", :link, :teacher_id)');
